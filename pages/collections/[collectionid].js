...
const Collection = () => {
  ...
  // Nf92zrkri1if8epFPebxfavh0_Xdv3zo
  ...
  const marketPlaceModule = useMemo(() => {
    ...
    return sdk.getMarketplaceModule('0xe120b41f05aCc4350e1c069dF6C0BD8550887cD8');
  }, [provider]);
          ...
          <div className={style.socialIconsContainer}>
            <div className={style.socialIconsWrapper}>
              <div className={style.socialIconsContent}>
                <div className={style.socialIcon}>{/* <CgWebsite /> */}</div>
                <div className={style.divider} />
                <div className={style.socialIcon}>{/* <AiOutlineInstagram /> */}</div>
                <div className={style.divider} />
                <div className={style.socialIcon}>{/* <AiOutlineTwitter /> */}</div>
                <div className={style.divider} />
                <div className={style.socialIcon}>{/* <HiDotsVertical /> */}</div>
              </div>
            </div>
          </div>
        </div>
