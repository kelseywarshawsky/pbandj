  ...
  return (
    <div className={style.wrapper}>
      <div className={style.infoContainer}>
        <div className={style.accent}>Rosco Finbar's Vagabonds</div>
        <div className={style.nftTitle}>{selectedNft?.name}</div>
        <div className={style.otherInfo}>
          <div className={style.ownedBy}>
            Owned by <span className={style.accent}>Rosco, mutha fucka</span>
          </div>
      ...
      <div className={style.actionButtonsContainer}>
        <div className={style.actionButtons}>
          ...
          <div className={style.actionButton}>{/* <RiShareBoxLine /> */}</div>
          <div className={style.divider} />
          <div className={style.actionButton}>{/* <GiShare /> */}</div>
          <div className={style.divider} />
          <div className={`${style.actionButton} mr-2`}>{/* <FiMoreVertical /> */}</div>
        </div>
      </div>
    </div>
  );
